...
const howMuchPencil = (str) => {
    ...
    for (var i = 0; i < str.length + 1; i++) {
        var count = str.slice(i, str.length + 1);
        result.push(count);
    }
    return result;
};
...
const listFoods = (recipe) => {
    ...
    for (var i = 0; i < recipe.ingredients.length; i++) {
        var counter = 0;
        for (var j = 0; j < recipe.ingredients[i].length; j++) {
            if (recipe.ingredients[i][j] === ' ' && counter < 2) {
                recipe.ingredients[i] = recipe.ingredients[i].slice(j + 1, recipe.ingredients[i].length);
                counter++;
            }
...
const stepActions = (recipe) => {
    let result = [];
    // Solution code here...
    // var example = recipe.steps;
    // for (var i = 0; i < recipe.steps.length; i++) {
    //     for (let j = 0; j < recipe.steps[i].length; j++) {
    //         if (recipe.steps[i][j] === ' ') {
